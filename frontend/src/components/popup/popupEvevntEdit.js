...
const PopupEventsEdit = ({isOpen, onClose}) => {
                    ...
                    <div className='popup-project-edit-container'>
                        <form className='form-popup-task' action="#">
                            <div className='input-description-container'>                        
                                <span className='input-description-heading input-heading'>Название мероприятия</span>
                            ...
                            <div className='input-description-container'>
                                ...
                                <h5 className='input-description-description'>1-2 предложение, в которых поясняется смысл мероприятия</h5>                        
                            </div>
...
export default PopupEventsEdit;